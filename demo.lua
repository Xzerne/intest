...
function topos(targetCFrame)
    ...
    -- 🔄 Nếu truyền Vector3 thì đổi sang CFrame
    ...
    -- 📦 Tạo platform
    local part = char:FindFirstChild("PartTele")
    if not part then
    ...
    while task.wait() do
        pcall(function()
            ...
            local enabled =
                ...
                or _G.TeleportNPC
                or _G.SafeMode
                or _G.AutoPlayerHunter
                or _G.AutoKillPlayer
                or _G.TeleportPly
                or _G.AutoQuestBoss
                or _G.AutoAllBoss
                or _G.AutoFarmLevelNew
                or _G.FarmSummer
                or _G.BossPain

            local hrp = game:GetService("Players")
